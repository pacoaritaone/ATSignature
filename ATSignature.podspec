...
Pod::Spec.new do |s|
  s.name             = 'ATSignature'
  s.version          = '0.1.0'
  s.summary          = 'It is one of the most simple customized signature view with basic controls https://github.com/pacoaritaone/ATSignature '
  ...
  s.homepage         = 'https://github.com/pacoaritaone/ATSignature'
  # s.screenshots     = 'github.com/pacoaritaone/ATSignature/blob/master/Screenshots/screenshot1.png', 'github.com/pacoaritaone/ATSignature/blob/master/Screenshots/screenshot2.png'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'AppTasnk - paco.yeung' => 'paco.yeung@eventionapp.com' }
  s.source           = { :git => 'https://github.com/pacoaritaone/ATSignature.git', :tag => s.version.to_s }
